...
#include "../../ProblemeDuVoyageurDeCommerce/sommet.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Sommet_t, stringdata0) + ofs \
...
void Sommet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Sommet::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sommet::sommetClicke)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Sommet::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Sommet.data,
      qt_meta_data_Sommet,  qt_static_metacall, nullptr, nullptr}
};
...
void *Sommet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Sommet.stringdata0))
